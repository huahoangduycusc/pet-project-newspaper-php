...
?>
<div class="panel-title"><h3>Bình luận</h3></div>
...
<div class="col-4 col-sm-4" style="margin-top:10px">
    <a href="?m=comment&a=report" class="button bg-danger"><i class="fas fa-flag"></i> Bình luận vi phạm</a>
</div>
<div class="row">
    <div class="col-12 col-m-12">
        <div class="card">
            <div class="card-header"><h3>Danh sách bình luận</h3></div>
                    ...
                    <tbody>
                        ...
                        foreach($list as $item)
                        {
                            ...
                            <tr>
                                ...
                                <td><a href=""><?php echo $item['article_name'];?></a></td>
                                <td>
                                    <a href="?m=comment&a=index&do=delete&id=<?php echo $item['cmt_id'];?>" class="btn-circle bg-danger" onclick="if (! confirm('Continue?')) { return false; }"><i class="fas fa-times"></i></a>
                                </td>
                            </tr>
                            <?php
                        }
        ...
        <?php
        $demtrang = db_count('comment','cmt_id');
        $config = [
            'total' => $demtrang,
            'querys' => $id,
            'limit' => $limit,
            'url' => 'admin/?m=comment&a=index'
        ];
